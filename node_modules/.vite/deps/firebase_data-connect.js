...
var AppCheckTokenProvider = class {
  constructor(app, appCheckProvider) {
    ...
    if (!this.appCheck) {
      void (appCheckProvider == null ? void 0 : appCheckProvider.get().then((appCheck) => this.appCheck = appCheck).catch());
    }
  }
  getToken() {
  ...
  addTokenChangeListener(listener) {
    var _a;
    void ((_a = this.appCheckProvider) == null ? void 0 : _a.get().then((appCheck) => appCheck.addTokenListener(listener)));
  }
};
var Code = {
  OTHER: "other",
...
var FirebaseAuthProvider = class {
  ...
  addTokenChangeListener(listener) {
    var _a;
    (_a = this._auth) == null ? void 0 : _a.addAuthTokenListener(listener);
  }
...
var QueryManager = class {
  ...
  addSubscription(queryRef2, onResultCallback, onCompleteCallback, onErrorCallback, initialCache) {
    ...
    const unsubscribe = () => {
      ...
      onCompleteCallback == null ? void 0 : onCompleteCallback();
    };
...
var RESTTransport = class {
  constructor(options, apiKey, appId, authProvider, appCheckProvider, transportOptions, _isUsingGen = false, _callerSdkType = CallerSdkTypeEnum.Base) {
    ...
    (_a = this.authProvider) == null ? void 0 : _a.addTokenChangeListener((token) => {
      logDebug(`New Token Available: ${token}`);
      this._accessToken = token;
    });
    (_b = this.appCheckProvider) == null ? void 0 : _b.addTokenChangeListener((result) => {
      const { token } = result;
  ...
  async getWithAuth(forceToken = false) {
    ...
    if (this.appCheckProvider) {
      this._appCheckToken = (_a = await this.appCheckProvider.getToken()) == null ? void 0 : _a.token;
    }
